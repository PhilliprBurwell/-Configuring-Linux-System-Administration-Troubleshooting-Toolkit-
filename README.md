...
(Image)
#2 Next, you will extract a .tar archive. The archive "extract_me.tar" is located in "/home/qwiklab/downloads/". Move to that directory, using cd /home/qwiklab/downloads. You can use the Linux tar command to extract it using sudo tar -xvf extract_me.tar. The contents of the archive (the file named "great_job") are then extracted
